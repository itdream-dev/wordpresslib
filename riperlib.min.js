...
if(accounts.length===0){console.log('Please connect to MetaMask.');$('#btn_buy_nft').prop("disabled",true);$('#btn_buy_nft').html('Connect with Metamask')}else if(accounts[0]!==currentAccount){currentAccount=accounts[0];$('#status').html('')
if(currentAccount!=null){$('#btn_buy_nft').prop("disabled",false);$('.status_span_wallet_connection').html(currentAccount.substr(0,10)+"...")
